...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    ...
    let mailOptions = {
      ...
      subject: "Someone is getting in touch!",
                          ...
                          <tr>
                            ...
                            >
                              <table
                                ...
                                cellspacing="0"
                                cellpadding="0"
                                style="background:#006400; border-radius:10px; box-shadow: 0px 4px 15px 0px rgba(0, 0, 0, 0.32);"
                              >
                                <tr>
                                  <td
                                    align="center"
                                ...
                                <td align="center" style="padding:40px 10px">
                                  ...
                                  >
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <a
                                          href="mailto:demsaftech@gmail.com"
                                          style="color:#ffffff; text-decoration:none!important"
                                          >demsaftech@gmail.com</a
                                        >
                                      </td>
                                    </tr>
                                  </table>
