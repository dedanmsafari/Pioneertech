    ...
    <Grid item container direction='column'>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            src={design}
            alt='pain brush leaving stroke of paint'
            width='100%'
            style={{ maxWidth: 1000 }}
          />
        </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            src={build}
            alt='Construction crane adjacent to building'
            width='100%'
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img
            src={maintain}
            alt='Wrench turning  a set of bolts'
            width='100%'
            style={{ maxWidth: 500 }}
          />
        </Grid>
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: 'center' }}>
          <img src={iterate} alt='A set of falling Dominoes' width='100%' />
        </Grid>
      </Grid>
      <Grid item>
